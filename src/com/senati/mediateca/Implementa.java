...
public class Implementa {
	...
	public static void main(String[] args) {
		...
		Cintaaudio audio1 =new Cintaaudio(10,"Musica variada", "franklin hv", 30, "Comas", 10);
		Cintaaudio audio2 =new Cintaaudio(11,"Mix", "yajaira", 50, "surco", 7);
		System.out.println(audio1);
		System.out.println(audio2);
		
		
		Cintavideo video1 = new Cintavideo(1, "el oso ted", "ted", 10,"daniel", 1000);
		...
		Socio soc3 = new Socio(105,"Gerardo", "Luque","callao");
		Socio soc4 = new Socio(106,"Alex", "Lopez","bellavista");
		Socio soc5 = new Socio(107,"Alex", "Lopez","collique");
		...
		Cintaaudio aud1 = new Cintaaudio(10,"Musica variada", "franklin hv", 30, "Comas", 10);
		Cintaaudio aud2 = new Cintaaudio(11,"Musica variada", "Jfranklin hv", 30, "Comas", 10);
		Cintaaudio aud3 = new Cintaaudio(12,"Musica variada", "Jfranklin hv", 30, "Comas", 10);
		Cintaaudio aud4 = new Cintaaudio(13,"Musica variada", "franklin hv", 30, "Comas", 10);
		Cintaaudio aud5 = new Cintaaudio(14 ,"Musica variada","franklin hv", 30, "Comas", 10);
		...
		Cintavideo vid1 = new Cintavideo(10,"video variado", "franklin hv", 30, "Comas", 10);
		Cintavideo vid2 = new Cintavideo(11,"video variado", "franklin hv", 30, "Comas", 10);
		Cintavideo vid3 = new Cintavideo(12,"video variado", "franklin hv", 30, "Comas", 10);
		Cintavideo vid4 = new Cintavideo(13,"video variado", "franklin hv", 30, "Comas", 10);
		Cintavideo vid5 = new Cintavideo(14,"video variado", "Jfranklin hv", 30, "Comas", 10);
